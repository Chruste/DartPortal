...
$extraHead = '<link rel="stylesheet" href="' . htmlspecialchars(portal_asset_url('/shanghai21/styles.css'), ENT_QUOTES, 'UTF-8') . '">';
...
?>
  ...
  <script src="<?= htmlspecialchars(portal_asset_url('/shanghai21/script.js'), ENT_QUOTES, 'UTF-8'); ?>"></script>
  <script>
